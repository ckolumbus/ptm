...
//		private static ProcessInfo GetCurrentProcessesInfo()
//		{
//			ProcessInfo procInfo = new ProcessInfo();
//			Process proc = Process.GetCurrentProcess();
//			procInfo.Id = proc.Id;
//			procInfo.MainModuleName = proc.MainModule.ModuleName;
//			procInfo.MainWindowHandle = proc.MainWindowHandle;
//			procInfo.MainModuleFileName =  proc.MainModule.FileName;
//			procInfo.MainWindowTitle = proc.MainWindowTitle;
//			return procInfo;
//		}
//
...
//				ProcessInfo procInfo = GetCurrentProcessesInfo();
//
//				IntPtr hwnd = procInfo.MainWindowHandle;
//				if (hwnd == IntPtr.Zero)
//				{
//					return;
//				}
...
//				hwndInt32 = hwnd.ToInt32();
//				// This is a PTM.Framework.Infos.ApplicationLog
//				ApplicationLog applicationLog = FindCurrentApplication(hwndInt32);
//				if (applicationLog == null)
//				{
//					// First time this application is detected
//					applicationLog = new ApplicationLog();
//					applicationLog.MainWindowHandle =hwndInt32;
//					applicationLog.ApplicationFullPath = procInfo.MainModuleFileName;
//					applicationLog.Name = procInfo.MainModuleName;
//					applicationLog.Caption = procInfo.MainWindowTitle;
...
//		/// Applications log.
//		/// </summary>
//		private static ApplicationLog FindCurrentApplication(int id)
//		{
//			ApplicationLog result = null;
//			foreach (ApplicationLog application in currentApplicationsLog)
//			{
//				if (application.MainWindowHandle == id)
//				{
//					result = application;
//				} //if
//			} //foreach
