...
namespace System.Runtime.InteropServices.APIs
{
	internal class APIsUser32
	{
		...
		static internal extern uint SendInput(uint nInputs, APIsStructs.INPUT[] inputs, int cbSize);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool ScreenToClient(IntPtr hWnd, ref APIsStructs.POINTAPI point);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int DrawFrameControl(IntPtr hDc, APIsStructs.RECT rect, APIsEnums.DrawFrameControlFlags nType, APIsEnums.DrawFrameControlStateFlags nState);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int GetSysColor(APIsEnums.SystemColors nIndex);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool DestroyIcon(IntPtr hIcon);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool GetComboBoxInfo(IntPtr hWnd, ref APIsStructs.PCOMBOBOXINFO cbi);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool DestroyWindow(IntPtr hWnd);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool ShowWindow(IntPtr hWnd, APIsEnums.ShowWindowStyles State);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool UpdateWindow(IntPtr hWnd);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern IntPtr SetClipboardData( uint Format, IntPtr hData);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool GetMenuItemRect(IntPtr hWnd, IntPtr hMenu, uint Item, ref APIsStructs.RECT rc);
		[DllImport("user32.dll", ExactSpelling=true, CharSet=CharSet.Auto)]
		internal static extern IntPtr GetParent(IntPtr hWnd);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern int SendMessage(IntPtr hWnd, APIsEnums.HeaderControlMessages msg, int wParam, ref APIsStructs.HDITEM lParam);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern int SendMessage(IntPtr hWnd, int msg, int wParam, int lParam);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern int SendMessage(IntPtr hWnd, APIsEnums.HeaderControlMessages msg, IntPtr wParam, ref APIsStructs.HD_HITTESTINFO hd_hittestinfo);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static int DrawText(IntPtr hdc, string lpString, int nCount, ref APIsStructs.RECT lpRect, APIsEnums.DrawTextFormatFlags flags);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static IntPtr SetParent(IntPtr hChild, IntPtr hParent);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static IntPtr GetDlgItem(IntPtr hDlg, int nControlID);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static int GetClientRect(IntPtr hWnd, ref APIsStructs.RECT rc);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static int InvalidateRect(IntPtr hWnd,  ref APIsStructs.RECT rc, int bErase);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal extern static int InvalidateRect(IntPtr hWnd,  IntPtr rc, int bErase);
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		internal static extern bool WaitMessage();
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		internal static extern bool PeekMessage(ref APIsStructs.MSG msg, int hWnd, uint wFilterMin, uint wFilterMax, APIsEnums.PeekMessageFlags flags);
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		internal static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst, ref APIsStructs.POINTAPI pptDst, ref APIsStructs.SIZE psize, 
		...
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		internal static extern int GetClassName(IntPtr hWnd, System.Text.StringBuilder ClassName, int nMaxCount);
		[DllImport("User32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int GetSystemMetrics(APIsEnums.SystemMetricsCodes code);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int SetScrollInfo(IntPtr hwnd,  int bar, ref APIsStructs.SCROLLINFO si, int fRedraw);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int ShowScrollBar(IntPtr hWnd, int bar,  int show);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int EnableScrollBar(IntPtr hWnd, uint flags, uint arrows);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int BringWindowToTop(IntPtr hWnd);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int GetScrollInfo(IntPtr hwnd, int bar, ref APIsStructs.SCROLLINFO si);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool ValidateRect(IntPtr hWnd, ref APIsStructs.RECT rcInvalidated);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern bool ValidateRect(IntPtr hWnd, IntPtr rc);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int GetScrollBarInfo(IntPtr hWnd, APIsEnums.SystemObjects id, ref APIsStructs.SCROLLBARINFO sbi);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int SetProp(IntPtr hWnd, IntPtr atom, IntPtr hData);
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		static internal extern int CallWindowProc(IntPtr hOldProc, IntPtr hWnd, uint message, int wParam, int lParam);
		[DllImport("user32.dll")]
		internal static extern bool SendMessage(IntPtr hWnd, APIsEnums.ListViewMessages msg,
			Int32 wParam, ref APIsStructs.LV_ITEM lParam);
		[DllImport("user32.dll")]
		internal static extern int SendMessage(IntPtr hWnd, Int32 msg, Int32 wParam, ref 
			APIsStructs.LVHITTESTINFO lParam);
		[DllImport("user32.dll")]
		internal static extern bool SendMessage(IntPtr hWnd, int msg,
