...
namespace System.Runtime.InteropServices.APIs
{
	internal class APIsUser32
	{
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern bool GetComboBoxInfo(IntPtr hWnd, ref APIsStructs.PCOMBOBOXINFO cbi);
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern bool SetWindowPos(IntPtr hWnd, Int32 hWndInsertAfter, int x, int y, int Width, int Height,
		                                         uint flags);
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern int SendMessage(IntPtr hWnd, APIsEnums.HeaderControlMessages msg, int wParam,
		...
		[DllImport("user32.dll", CharSet=CharSet.Auto)]
		internal static extern int SendMessage(IntPtr hWnd, APIsEnums.HeaderControlMessages msg, IntPtr wParam,
