...
namespace HansBlomme.Windows.Forms
{
    ...
    [ToolboxBitmap(typeof(HansBlomme.Windows.Forms.NotifyIcon), "HansBlomme.Windows.Forms.NotifyIcon.bmp"), ToolboxItemFilter("HansBlomme.Windows.Forms"), DefaultProperty("Text"), DefaultEvent("MouseDown")]
    public sealed class NotifyIcon : Component
    {
        [Category("Action"), Description("Occurs when the balloon is dismissed because of a mouse click.")]
        public event HansBlomme.Windows.Forms.NotifyIcon.BalloonClickEventHandler BalloonClick;
        ...
        public event HansBlomme.Windows.Forms.NotifyIcon.BalloonHideEventHandler BalloonHide;
        [Category("Behavior"), Description("Occurs when the balloon is shown (balloons are queued).")]
        public event HansBlomme.Windows.Forms.NotifyIcon.BalloonShowEventHandler BalloonShow;
        [Description("Occurs when the balloon is dismissed because of a timeout."), Category("Behavior")]
        public event HansBlomme.Windows.Forms.NotifyIcon.BalloonTimeoutEventHandler BalloonTimeout;
        [Description("Occurs when the user clicks the icon in the status area."), Category("Action")]
        public event HansBlomme.Windows.Forms.NotifyIcon.ClickEventHandler Click;
        [Description("Occurs when the user double-clicks the icon in the status notification area of the taskbar."), Category("Action")]
        public event HansBlomme.Windows.Forms.NotifyIcon.DoubleClickEventHandler DoubleClick;
        ...
        public event HansBlomme.Windows.Forms.NotifyIcon.MouseDownEventHandler MouseDown;
        ...
        public event HansBlomme.Windows.Forms.NotifyIcon.MouseMoveEventHandler MouseMove;
        ...
        public event HansBlomme.Windows.Forms.NotifyIcon.MouseUpEventHandler MouseUp;
        ...
        private void Initialize()
        {
            ...
            this.NID.cbSize = Marshal.SizeOf(typeof(HansBlomme.Windows.Forms.NotifyIcon.NOTIFYICONDATA));
            this.NID.uFlags = 7;
...
//		}
        ...
        private static extern bool Shell_NotifyIcon(int dwMessage, ref HansBlomme.Windows.Forms.NotifyIcon.NOTIFYICONDATA lpData);
        public void ShowBalloon(EBalloonIcon Icon, string Text, string Title, [Optional] int Timeout /* = 0x3a98 */)
        {
            ...
            {
                HansBlomme.Windows.Forms.NotifyIcon.Shell_NotifyIcon(1, ref this.NID);
            }
            this.NID.uFlags &= -17;
        }
        ...
        public bool Visible
        {
            ...
            set
            {
                ...
                if (!this.DesignMode)
                {
                    if (this.m_Visible)
                    {
                        HansBlomme.Windows.Forms.NotifyIcon.Shell_NotifyIcon(0, ref this.NID);
                    }
                    else
                    {
                        HansBlomme.Windows.Forms.NotifyIcon.Shell_NotifyIcon(2, ref this.NID);
                    }
                }
            }
        }
        ...
        private HansBlomme.Windows.Forms.NotifyIcon.NOTIFYICONDATA NID;
        ...
        {
            public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.BalloonClickEventHandler BalloonClick;
            public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.BalloonHideEventHandler BalloonHide;
            public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.BalloonShowEventHandler BalloonShow;
            public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.BalloonTimeoutEventHandler BalloonTimeout;
            new public  event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.ClickEventHandler Click;
        	new public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.DoubleClickEventHandler DoubleClick;
            new public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.MouseDownEventHandler MouseDown;
            new public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.MouseMoveEventHandler MouseMove;
            new public event HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.MouseUpEventHandler MouseUp;
            public event ReloadEventHandler Reload;
        	//public event MenuItemRightClickEventHandler MenuItemRightClick;
        	
            public MessageHandler()
            {
                this.WM_TASKBARCREATED = HansBlomme.Windows.Forms.NotifyIcon.MessageHandler.RegisterWindowMessage("TaskbarCreated");
